...
{
    public class ContratoCompraVendaController : ApiController
    {
      public HttpResponseMessage Get()
      {
         ...
         report.ReportPath = System.Web.Hosting.HostingEnvironment.MapPath("~/Reports/Contratos/relContratoCompraVenda.rdlc");
